...
> 目標:把企業 AI 從「功能很多的入口頁」重構成「每天真的拿來工作的 AI 作業系統」。
...
本公司的真實工作不是一次對話,而是一個案子。Project / Handoff 已經有後端能力,但 UI 還沒有把「每件工作都回到專案包」做成唯一主線。
...
「CRM」「Skills」「Knowledge」「Workflow」「Accounting」對開發者清楚,但對本公司同仁更自然的是:
