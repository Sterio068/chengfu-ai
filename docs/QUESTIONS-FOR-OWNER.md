...
> Sterio 帶這份去跟本公司老闆 + Champion 開 30 分鐘會議,把答案寫回每題下方,然後 v1.1 實作就有依據。
...
### Q1. 本公司常見招標 PDF · 掃描件 vs born-digital 比例?

**本公司答(2026-04-21):** **OCR 要進容器** · 代表掃描件佔比不低(30%+)
