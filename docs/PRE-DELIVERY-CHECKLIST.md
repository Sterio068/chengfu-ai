...
### 上午(2 小時)· 全員 Onboarding
- [ ] 全員到場 · 發紙條 · 每人連自己筆電登入成功
- [ ] Sterio 示範:Launcher 結構 + ⌘K palette + onboarding 3 步
- [ ] Champion 示範:海廢案 walk-through(15 分鐘精簡版)
- [ ] 分組練習:每 2 人 1 組,輪流試 5 個情境:
  - 寫中秋節 LINE 訊息給客戶
  - 貼一段招標須知判 Go/No-Go
  - 請 3 家廠商報價比價信
  - 新聞稿 400 字
...
### 下午(1.5 小時)· 進階分層
- [ ] PM 組:專案管理 + 跨助手接力 + Admin 面板
- [ ] 設計組:設計 Brief + 多渠道適配
- [ ] 業務組:標案監測 + CRM Kanban + LINE 貼上清理
