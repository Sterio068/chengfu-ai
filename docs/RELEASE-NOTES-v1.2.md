...
**v1.1 工程強化 → v1.2 加 6 個新功能 + 17 項優化 + 全 4 個 frontend view + 9 輪 audit · 月省 120+ 小時 / 10 人 · 本公司全 AI 工作流真實上線。**
...
- 真 Meta/LinkedIn API 等本公司老闆走 developer app 審核(1-2 週)
...
- `Company-AI-Installer.app` v1.2:6 步對話框(加 OpenAI key 必填提示)+ LINE Notify 提示 + iPhone HEIC 提示
...
| 📇 媒體 CRM | 本公司歷史記者 ≥ 50 筆建檔 · ≥ 3 PM 實用 | 未達標 · 匯入 CSV 幫忙 |
...
user_preferences · feedback · meetings · site_surveys · scheduled_posts · knowledge_audit · company_ai_quota_overrides · design_jobs · agent_overrides
...
- case-insensitive(legacy mixed-case 'Leaving@CompanyAI.Local' 也清)
