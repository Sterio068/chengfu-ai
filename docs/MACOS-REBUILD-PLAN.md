...
> 改:default seed **7 個 icon**(本公司 10 agent 的核心 7 個)· 開機就滿 · 老闆一登入看到漂亮 dock
...
### Sprint B(3-4 天)
- Phase 3 Menu bar(本公司 / 檔案 / 編輯 / 顯示 / 視窗 / 說明 + 右側 status)
