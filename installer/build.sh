...
/usr/libexec/PlistBuddy -c "Set :CFBundleShortVersionString 1.2.0" "$PLIST" 2>/dev/null || \
    /usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string '1.2.0'" "$PLIST"
echo -e "  ${GREEN}✓${NC} 中文名 + 版本 1.2.0"
